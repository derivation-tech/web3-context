...
- **Singleton Chain Management**: `ChainInstance` provides per-chain utilities
...
import { ChainInstance, ERC20, WETH } from '@derivation-tech/viem-context';
...
```typescript
import { ChainInstance } from '@derivation-tech/viem-context';
