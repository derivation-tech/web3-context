...
export interface WrappedNativeInterface extends utils.Interface {
    functions: {
...
export interface WrappedNative extends BaseContract {
    ...
    functions: {
        ...
        'withdraw(uint256)'(wad: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
    ...
    estimateGas: {
        ...
        'withdraw(uint256)'(wad: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
