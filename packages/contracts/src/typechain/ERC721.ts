...
export interface ERC721 extends BaseContract {
    ...
    functions: {
        ...
        'balanceOf(address)'(owner: string, overrides?: CallOverrides): Promise<[BigNumber] & { balance: BigNumber }>;
        ...
        'ownerOf(uint256)'(tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string] & { owner: string }>;
