...
export interface Multicall3Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'aggregate((address,bytes)[])', values: [Multicall3.CallStruct[]]): string;
    ...
    encodeFunctionData(functionFragment: 'getBlockHash(uint256)', values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'getEthBalance(address)', values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: 'aggregate((address,bytes)[])', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'aggregate3', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'aggregate3((address,bool,bytes)[])', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'aggregate3Value', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'aggregate3Value((address,bool,uint256,bytes)[])', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'blockAndAggregate', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'blockAndAggregate((address,bytes)[])', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'getBlockHash(uint256)', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'getEthBalance(address)', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'tryAggregate(bool,(address,bytes)[])', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'tryBlockAndAggregate', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'tryBlockAndAggregate(bool,(address,bytes)[])', data: BytesLike): Result;
